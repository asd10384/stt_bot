...
export class BotClient extends Client {
  ...
  public sttClass: Map<string, STT>;
  ...
  getSTT(guild: Guild): STT {
    if (!this.sttClass.has(guild.id)) this.sttClass.set(guild.id, new STT(guild));
    return this.sttClass.get(guild.id)!;
  }
